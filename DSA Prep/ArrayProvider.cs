...
namespace DSA_Prep
{
    ...
    { 
        ...
        { 
            ...
            Maximum_Product_SubArray.Max_Product_SubArray([2, 3, -2, 4]);


            //get longest consecutive subsequence
            Longest_Consecutive_SubSequence.Longest_Sonsecutive([1, 1,  1, 8, 7, 9, 3, 10, 4, 20, 2, 6, 5]);

            Elements_nby3_times.FindElements_NBy3_Times([1, 2, 1, 2, 1, 1]);
        }
    }
}
